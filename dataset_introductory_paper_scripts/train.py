...
if __name__ == "__main__":
    ...
    parser.add_argument('--path_rgb', type=str, default='/data/254p RGB Images', help='results path') #the path change, may diferent from the README. Please view github for detail.
    parser.add_argument('--path_ir', type=str, default='/data/254p RGB Images', help='results path')
